"""
HBNNV2.py: Automated Experiments for HBNN
----------------------------------------
- Loops over all priors for the current feature set
- Uses feature names in all outputs
- Adds SHAP summary plots
- Saves all results in results/{prior}/
- Outputs a comparison summary at the end
"""
import torch
...
# --- Begin Experiment Script ---
if __name__ == "__main__":
    print("[INFO] Starting HBNN automated experiments pipeline...")
    # Data setup
    ...
    priors = ['normal', 'laplace', 'student_t', 'mixture']
    results_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'resultsV2')
