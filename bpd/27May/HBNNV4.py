"""
HBNNV4.py: Enhanced True Hierarchical Bayesian Neural Network
------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    results_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'resultsV4')
